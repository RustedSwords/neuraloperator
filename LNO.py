...
class MyNet(torch.nn.Module):
    def __init__(self, s, width=32, rank=4):
        ...
        self.net1 = LowRank(self.width, self.width, s, width, rank=self.rank)
        self.net2 = LowRank(self.width, self.width, s, width, rank=self.rank)
        self.net3 = LowRank(self.width, self.width, s, width, rank=self.rank)
        self.net4 = LowRank(self.width, self.width, s, width, rank=self.rank)
...
################################################################
dataloader = MatReader('/home/rusted/Projects/Thesis/neuraloperator/data/burgers_data_R10.mat')
